...
Huna7.Startup.Logo = (() => {
  ...
  const render = (container, opts = {}) => {
    ...
    svg.style.cssText = animated ? 'opacity:0;transform:scale(0.7);transition:opacity 600ms cubic-bezier(0.2,0.8,0.3,1),transform 600ms cubic-bezier(0.34,1.56,0.64,1);' : '';
    ...
    if (animated) barL.style.cssText = 'opacity:0;transform:translateY(8px);transition:opacity 400ms ease 500ms,transform 400ms cubic-bezier(0.2,0.8,0.3,1) 500ms;';
    ...
    if (animated) barR.style.cssText = 'opacity:0;transform:translateY(8px);transition:opacity 400ms ease 600ms,transform 400ms cubic-bezier(0.2,0.8,0.3,1) 600ms;';
    ...
    wordmark.style.cssText = `font-size:${fs}px;font-weight:800;letter-spacing:-0.04em;
      ...
      ${animated ? 'opacity:0;transform:translateY(6px);transition:opacity 400ms ease 800ms,transform 400ms ease 800ms;' : ''}`;
    ...
    sub.style.cssText = `font-size:${Math.round(fs * 0.55)}px;color:rgba(255,255,255,0.35);letter-spacing:0.12em;text-transform:uppercase;font-weight:500;
      ${animated ? 'opacity:0;transition:opacity 400ms ease 950ms;' : ''}`;
