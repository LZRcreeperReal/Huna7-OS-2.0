...
Huna7.Apps.VoxStudio = (() => {
  function launch(pid, options = {}) {
    ...
    function mkBtn(icon, label, action, cls='h7-btn-ghost') {
    ...
    function stopScript() { isRunning = false; runBtn.style.display = ''; stopBtn.style.display = 'none'; consoleLog('■ Stopped', 'info'); };
