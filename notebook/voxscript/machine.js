  ...
  class VM {
    ...
    _step(frame, instr) {
      ...
      switch (instr.op) {
        ...
        case op.SET_PROP: {
          const val = frame.pop(), obj = frame.peek();
        ...
        case op.CALL_METHOD: {
          ...
          const obj = frame.pop();
          if (typeof obj?.[method] === 'function') frame.push(obj[method](...args) ?? null);
          else if (obj instanceof VoxFn) { this._callFn(obj, args); }
