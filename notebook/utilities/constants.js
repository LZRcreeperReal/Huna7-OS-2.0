...
Huna7.CONSTANTS = {
  ...
  // Boot timing — total ~4 seconds
  BOOT_STAGES: [
    { id: 'firmware',  label: 'Firmware Initialization',     duration: 300 },
    { id: 'storage',   label: 'Storage Mount',               duration: 400 },
    { id: 'kernel',    label: 'Kernel Startup',              duration: 300 },
    { id: 'services',  label: 'Service Registration',        duration: 300 },
    { id: 'desktop',   label: 'Desktop Environment Launch',  duration: 200 },
  ],
