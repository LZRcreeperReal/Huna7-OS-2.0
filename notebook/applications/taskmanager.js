...
Huna7.Apps.Writer = (() => {
  function launch(pid, options = {}) {
    ...
    function mkBtn(icon, title, action, label = '') {
    ...
    // Tab management
    async function openTab(filePath = null, content = '') {
    ...
    function highlightMatches() { /* Basic highlight via textarea selection */ };
